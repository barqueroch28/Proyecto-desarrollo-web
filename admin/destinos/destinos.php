        ...
        if ($result = mysqli_query($con, $sql)) {
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              $descr = substr($row['descripcion'], 0, 350);
              echo "<td>" . $descr . "...</td>";
              echo "<td>" . $row['costo'] . "</td>";
              echo "<td class='w-25'><img src='img/" . $row['imagen'] . "' width='60%'></td>";
              echo "<td>";
              echo '<a href="update.php?id_destino=' . $row['id_destino'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
              echo '<a href="delete.php?id_destino=' . $row['id_destino'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
              echo "</td>";
              echo "</tr>";
            }
            echo "</tbody>";
