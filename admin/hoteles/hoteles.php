        ...
        if ($result = mysqli_query($con, $sql)) {
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo "<td>";
              echo '<a href="update.php?id_hotel=' . $row['id_hotel'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
              echo '<a href="delete.php?id_hotel=' . $row['id_hotel'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
              echo "</td>";
              echo "</tr>";
            }
            echo "</tbody>";
